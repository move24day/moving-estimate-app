...
items = {
    '가정': {
        '장롱': (1.7, 140.0), '붙박이장': (1.25, 160.0), '더블침대': (2.1, 110.0), 
        '싱글침대': (1.6, 80.0), '매트': (1.2, 50.0), '서랍장(5단)': (0.75, 40.0), 
        '화장대': (0.32, 80.0), '책장': (0.96, 56.0), '책상&의자': (0.48, 40.0), 
        '옷행거': (0.35, 40.0), '소파(3인용)': (0.6, 50.0), 'TV(45인치)': (0.15, 15.0),
        '에어컨': (0.15, 30.0), '피아노(일반)': (1.5, 200.0), '피아노(디지털)': (0.5, 50.0),
        '4도어 냉장고': (1.2, 130.0), '김치냉장고(스탠드형)': (0.8, 90.0), '김치냉장고(일반형)': (0.6, 60.0),
        '식탁(4인)': (0.4, 50.0), '주방용 선반(수납장)': (1.1, 80.0), '세탁기 및 건조기': (0.5, 80.0),
        '신발장': (0.9, 60.0),
        '소파 테이블': (0.65, 35.0)
    },
    '기타': {
        '소파(1인용)': (0.4, 30.0), 'TV(75인치)': (0.3, 30.0), '장식장': (0.75, 40.0),
        '오디오 및 스피커': (0.1, 20.0), '공기청정기': (0.1, 8.0), '양문형 냉장고': (1.0, 120.0), 
        '신발장': (1.1, 60.0), '식탁(6인)': (0.6, 70.0), '가스레인지 및 인덕션': (0.1, 10.0),
        '여행가방 및 캐리어': (0.15, 5.0), '화분': (0.2, 10.0), '스타일러스': (0.5, 20.0),
        '안마기': (0.9, 50.0)
    }
}
